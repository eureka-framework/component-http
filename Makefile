.PHONY: validate install update deps phpcs phpcsf php81compatibility php74compatibility phpstan analyze tests testdox ci clean build/reports/phpunit build/reports/phpcs build/reports/phpstan
...
ci: clean validate deps install phpcs tests integration php74compatibility php83compatibility analyze
