...
class Uri implements UriInterface
{
     ...
     * @return self
     */
    private function setUserInfo(string $user, string $pass): self
    {
     ...
     * @return string
     */
    private function encode(array $match): string
    {
     ...
     * @return string
     */
    private function getStringValue(&$var, string $default = ''): string
    {
        $value = $default;
